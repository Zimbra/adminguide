...
Use `zmskindeploy` to simplify the process of deploying skins in the {web-app-term}.  This
tool processes the skin deployment, enables the skin for all users of the
the {web-app-term} deployment, and restarts the web server so that it recognizes the new
skin.
////
