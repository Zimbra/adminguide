...
Select an _account_, from the *Gear* icon select *View Mail*.  The user's {web-app} account opens in a new browser window.
...
You can add owners to distribution lists and they manage the list from their {web-app} account's Address Book, Distribution List folder. 
