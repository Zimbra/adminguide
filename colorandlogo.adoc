...
screens for the {web-app} and the {product-name} administration console.

|zimbraSkinLogoAppBanner |
The logo graphic file name for the graphic in the upper-left of the {web-app} application and the administration console.
