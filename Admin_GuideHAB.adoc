...
==== Explanation
_ZimbraOU_ as an organizational unit created.
...
A group needs to be specified as root so that other groups can be added child groups to comply with the organizational hierarchy.

Run below command to make _zimbra@example.com_ as root.
