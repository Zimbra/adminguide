...
Syntax:
    zxsuite mobile ABQ allow {device_id} [account_id user@domain.com]
...
Syntax:
    zxsuite mobile ABQ block {device_id} [account_id user@domain.com]
...
Syntax:
    zxsuite mobile ABQ set {device_id} [account_id user@domain.com] {Allowed|Blocked|Quarantined}
...
Syntax:
    zxsuite mobile ABQ delete {device_id} [account_id user@domain.com]
