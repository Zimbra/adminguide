...
Zimbra Talk and Zimbra Connect cannot coexist on a server, as their core components and Zimlets are incompatible with each other.
To fully use Connect, the database content must be migrated from Talk format to Connect format.
