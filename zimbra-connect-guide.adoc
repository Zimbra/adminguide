...
{zconnect-name} includes all _basic_ IM features, which automatically gets enabled for all users who don’t have access to the _advanced_ {zconnect-name} features.
