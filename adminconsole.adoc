...
The Gear Icon image:gear_icon.png[Gear Icon] is displayed with
...
| HSM |
(hierarchical storage management): Configure the aging of messages before they are
...
described in this section. Check <<#zimbra-pst-migration, Zimbra PST Migration>> to migrate Outlook PSTs to {product-name}.
