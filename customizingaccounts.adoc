...
ifdef::z9[]
[IMPORTANT]
Some features mentioned in the following sections may not be currently available for the {modern}. 
endif::z9[]
...
See also <<offline_mode,Offline Mode>>.
[NOTE]
Currently, this setting has no impact on {modern}.
endif::z9[]
...
ifdef::z9[]
Themes are currently not supported for {modern}.
endif::z9[]
...
ifdef::z9[]
[IMPORTANT]
Currently, these settings have no impact on the {modern}.
endif::z9[]
...
ifdef::z9[]
[NOTE]
Checkboxes are enabled by default on {modern}.
endif::z9[]
