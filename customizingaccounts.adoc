...
See also <<offline_mode,Offline Mode>>.
[NOTE]
Currently, this setting has no impact on the {modern-client}.
endif::z9[]
...
ifdef::z9[]
Themes are currently not supported for the {modern-client}.
endif::z9[]
...
ifdef::z9[]
[IMPORTANT]
Currently, these settings have no impact on the {modern-client}.
endif::z9[]
