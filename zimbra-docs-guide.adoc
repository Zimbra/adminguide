...
The Docs Extension and Docs Zimlet don't require any specific open port to be functional. All mailbox servers will need to be able to directly communicate with the Docs Server over port 8443 (HTTPS Backend), which must be open on both ends.
