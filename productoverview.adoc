...
is lost, the {web-app-term} automatically transitions to "`offline mode`".  When server
connectivity is restored, the {web-app-term} automatically reverts to "`online mode`".
