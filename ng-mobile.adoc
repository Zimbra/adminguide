...
Starting from Zimbra 8.8.15-Patch16, Mobile Passwords are now managed by the user via the new Auth Zimlet, which can be installed by running `zxsuite auth doDeployAuthZimlet`.
