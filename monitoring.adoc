...
Thread names in mailbox.log are prefixed to identify internal components. Most threads have one of the following naming conventsion: "*{thread prefix}-{thread number}*" or "*{thread prefix}-{thread number}:{url}*".
