...
Zimlets are a mechanism to integrate {product-short} with different third-party
...
{product-short} includes several predefined Zimlets. You can also create Zimlets or
...
accessed through a Zimlet. For the Zimlets that are included in {product-short}, proxy
